...
public final class Point2D implements Comparable<Point2D> {
    ...
    public Comparator<Point2D> adistanceToOrder() {
        return new ADistanceToOrder();
    }

    public Comparator<Point2D> ddistanceToOrder() {
        return new DDistanceToOrder();
    }
    ...
    // compare points according to their distance to this point
    private class ADistanceToOrder implements Comparator<Point2D> {
        public int compare(Point2D p, Point2D q) {
    ...
    // compare points according to their distance to this point
    private class DDistanceToOrder implements Comparator<Point2D> {
        public int compare(Point2D p, Point2D q) {
            double dist1 = distanceTo(p);
            double dist2 = distanceTo(q);
            if      (dist1 > dist2) return -1;
